...
<div class="register-container animated fadeInDown">
    <div class="registerbox bg-white" style="height: 610px !important;">
        <div class="registerbox-title">添加 ${name} 绩效</div>

        <div class="registerbox-caption "></div>
        <div class="registerbox-textbox">
            <textarea id="overview" style="width: 100%; height: 100px; resize: none;" placeholder="任务概述" ></textarea>
        </div>
        <div class="registerbox-textbox">
            任务完成率得分：
        ...
        <div class="registerbox-textbox">
            <textarea id="completionNote" style="width: 100%; height: 100px; resize: none;" placeholder="任务概述备注" ></textarea>
        </div>
        <hr class="wide" />
        <div class="registerbox-textbox">
            任务完成质量得分：
        ...
        <div class="registerbox-textbox">
            <textarea id="scoreNote" style="width: 100%; height: 100px; resize: none;" placeholder="任务完成质量得分备注" ></textarea>
        </div>
